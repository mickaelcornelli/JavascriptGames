...
function showGameWinner() {
    ...
    if(game.hpDragon > 0) {
        ...
        message = "Vous êtes mort ! Il ne restait plus rien de votre corps. Seul les cendres seront restituées à votre famille !";
    }
    // Sinon (le dragon est mort) c'est le joueur qui a gagné
        ...
        message = 'Vous avez vaincu le dragon ! Retournez narrer votre exploit à la taverne du village';
    }
